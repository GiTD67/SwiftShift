...
# Fields only a manager may change (even on their own record). hourly_rate is
# manager-controlled: it feeds payroll cost reports, so employees see it read-only.
